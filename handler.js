...
export async function participantsUpdate({ id, participants, action }) {
  ...
  let welbuf = await new knights.Welcome()
    ...
    let welc = `https://api.botcahx.biz.id/api/maker/welcome1?name=${names}&gpname=${namesg}&member=${user.length}&pp=${pp}&bg=${thumbnailUrl.getRandom()}&apikey=Admin`
    let weld = `https://api.dhamzxploit.my.id/api/canvas/welcome?pp=${pp}&name=${names}&bg=${thumbnailUrl.getRandom()}&grupname=${namesg}&member=${user.length}`
    let byea = `https://api.botcahx.biz.id/api/maker/goodbye1?name=${names}&gpname=${namesg}&member=${user.length}&pp=${pp}&bg=${thumbnailUrl.getRandom()}&apikey=Admin`
    let byeb = `https://api.dhamzxploit.my.id/api/canvas/goodbye?pp=${pp}&name=${names}&bg=${thumbnailUrl.getRandom()}&member=${user.length}`
